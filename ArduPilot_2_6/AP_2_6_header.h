...
#define GCS_PROTOCOL 0			// 0 = LabVIEW/HappyKillmore ground station, 1 = special test, 2 = Ardupilot Binary(not implemented), 5 = Jason's GCS
...
/* Stuff added by us */
/***************/
#define XBEE_BAUD_RATE  FIFTY_SEVEN_K_BAUD
